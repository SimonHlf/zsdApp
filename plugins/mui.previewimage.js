(function($, window) {
	...
	var PreviewImage = function(options) {
		this.options = $.extend(true, {
			...
			zoom: true,
			header: '<span class="mui-icon mui-icon-closeempty seveimgs_btu"></span><span class="mui-preview-indicator"></span>',
			footer: ''
		}, options || {});
		this.init();
		this.initEvent();
	...
	proto.addImage = function(img) {
		...
		var src = img.getAttribute('src');
		    if(!src)
		    {
		    src=img.getAttribute('data-preview-src');
		    	//console.log("src:"+src);
		    }
...
//		this.empty();
	...
	proto.isShowstat = function()
	{
		
	};
   proto.isClosestat = function()
	{
		//console.log("isclose");
	};
